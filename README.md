About mygeopackage-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mygeopackage-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12292&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mygeopackage-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mygeopackage` can be installed with `conda`:
...
```
mamba install mygeopackage
```

It is possible to list all of the versions of `mygeopackage` available on your platform with `conda`:
...
```
mamba search mygeopackage --channel conda-forge
```
...
mamba repoquery search mygeopackage --channel conda-forge

# List packages depending on `mygeopackage`:
mamba repoquery whoneeds mygeopackage --channel conda-forge

# List dependencies of `mygeopackage`:
mamba repoquery depends mygeopackage --channel conda-forge
```
